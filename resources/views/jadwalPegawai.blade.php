    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="{{URL('pegawai-jadwal')}}" class="nav-link active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="{{URL('pegawai-jadwal')}}">jadwal</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tabel Jadwal Penyuluhan</h3>
              </div>
              <!-- /.card-header -->
              @if($errors->any())
                    ...
                    <tr>
                      ...
                      <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit{{$jadwal->id_jadwal}}" ><i class="fa fa-pen"></i></button>
                          <div style="float:left;">
                            <form action="{{route('pegawai-jadwal.destroy', $jadwal->id_jadwal)}}" method="POST">
                                @csrf
                                @method('DELETE')
...
<div id="tambah" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form action="{{route('pegawai-jadwal.store')}}" class="form-horizontal tasi-form" method="post" enctype="multipart/form-data">
                @csrf
...
<div id="edit{{$jadwal->id_jadwal}}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <!-- body modal -->
            <div class="modal-body">
            <form action="{{route('pegawai-jadwal.update', $jadwal->id_jadwal)}}" class="form-horizontal tasi-form" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
