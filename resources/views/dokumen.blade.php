        ...
        <div class="container">
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    <p class="lead">Fitur Materi penyuluhan ini berisi tentang dokumen-dokumen rekapan hasil penyuluhan yang telah dilaksanakan. Sasaran penyuluhan kesehatan yaitu mencakup individu, keluarga, kelompok dan masyarakat.</p>
                </div>
            </div><!-- end title -->
            <hr class="invis"> 
            ...
            <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach($dokumens as $dokumen)
                    <tr>
                      <td width="2%">{{++$i}}</td>
                      <td width="24%">{{$dokumen->pegawai->nama}}</td>
                      <td width="50%"><a href="{{URL::to('/')}}/pdf/{{$dokumen->pdf}}">{{$dokumen->judul}}.pdf</a></td>
                      <td width="24%">{{$dokumen->kategori}}</td>
                       </td>
                    </tr>
                    @endforeach
                  </tbody>
