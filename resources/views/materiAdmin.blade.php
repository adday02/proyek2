                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @foreach($materis as $materi)
                    <tr>
                      ...
                      <td width="22%">{{$materi->pegawai->nama}}</td>
                      ...
                      <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit{{$materi->id_materi}}" ><i class="fa fa-pen"></i></button>
                          <div style="float:left;">
                            <form action="{{route('admin-materi.destroy', $materi->id_materi)}}" method="POST">
                                @csrf
                                @method('DELETE')
...
<div id="tambah" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form action="{{route('admin-materi.store')}}" class="form-horizontal tasi-form" method="post" enctype="multipart/form-data">
                @csrf
...
<div id="edit{{$materi->id_materi}}" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <!-- body modal -->
            <div class="modal-body">
            <form action="{{route('admin-materi.update', $materi->id_materi)}}" class="form-horizontal tasi-form" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                ...
                <div class="row form-group">
                    <label class="col-sm-4 control-label">Foto</label>
                    <div class="col-sm-8">        
                        <input type="file" name="foto" select="{{$kategori->foto}}">
                    </div>
                </div>
                ...
                <div class="row form-group">
                    <label class="col-sm-4 control-label">Video</label>
                    <div class="col-sm-8">        
                        <input type="file" name="video" select="{{$pegawai->video}}">
                    </div>
                </div>
